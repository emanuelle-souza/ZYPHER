...
<head>
    ...
    <link rel="stylesheet" href="/codigoprojeto/views/css/cadastro.css">
</head>
<body>
    <div class="container">
    <div class="f1">
        ...
        <div class="form-box">
        <form action="/codigoprojeto/salvausuario" method="POST">
 ...
 <div class="f2">
        <img src="/codigoprojeto/public/assets/midia/ouvidoria.png" class="ouvidoria">
        <img src="/codigoprojeto/public/assets/midia/logo.png" class="logo">
    </div>
